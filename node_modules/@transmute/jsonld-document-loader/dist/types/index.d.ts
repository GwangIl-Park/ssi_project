...
export declare type DocumentLoader = (uri: string) => Promise<IDocumentLoaderResponse>;
export interface DocumentLoaderManager extends IContextManager, IResolverManager {
    documentLoader: (uri: string) => Promise<IDocumentLoaderResponse>;
    addContext: (contextMap: IContextMap) => DocumentLoaderManager;
    addResolver: (startWithResolverMap: IStartsWithResolver) => DocumentLoaderManager;
