...
const preloadedDidDocument = JSON.parse(fs_1.readFileSync("data/public-did:key.json").toString("ascii"));
const verifier = verifier_1.createVerifier([preloadedDidDocument]);
const configureTestSuite = (success) => {
    ...
    describe(`${describeModifier} DCC Issuer`, () => {
        ...
        it(`should${itModifier}verify`, () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {
                'verificationMethod': keyId
            };
            const verificationResult = yield verifier.verify({
                verifiableCredential: simpleCredentialSigned,
                issuerMembershipRegistry: {},
                options
            });
            chai_1.expect(verificationResult.verified && verificationResult.valid).to.equal(success);
        })).slow(5000).timeout(10000);
        it(`should${itModifier}verify with DCC context`, () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {
                'verificationMethod': keyId
            };
            const verificationResult = yield verifier.verify({
        ...
        it(`should${itModifier}verify presentation`, () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {
                'challenge': challenge,
            };
            const verificationResult = yield verifier.verifyPresentation({
                verifiablePresentation,
                issuerMembershipRegistry: {},
                options
            });
