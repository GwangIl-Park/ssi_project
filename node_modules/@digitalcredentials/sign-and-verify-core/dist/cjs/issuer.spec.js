...
const unlockedDidDocument = JSON.parse(fs_1.readFileSync("data/unlocked-did:key.json").toString("ascii"));
const issuer = issuer_1.createIssuer([unlockedDidDocument], controller);
describe('Issuer test', () => {
    it('should create key', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect(result.id).to.equal(keyId);
        chai_1.expect(result.type).to.equal('Ed25519VerificationKey2020');
        chai_1.expect(result.controller).to.equal(controller);
    }));
    it('should sign', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect(result.issuer).to.equal(controller);
    ...
    it('should sign with DCC context', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect(result.issuer.id).to.equal(controller);
    })).slow(5000).timeout(10000);
    it('should sign presentation', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const vmResult = signatures_1.getProofProperty(result.proof, 'verificationMethod');
        chai_1.expect(vmResult).to.equal(keyId);
    })).slow(5000).timeout(10000);
});
